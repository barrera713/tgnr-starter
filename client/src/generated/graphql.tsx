...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'title' | 'text' | 'textSnippet' | 'points' | 'creatorId' | 'voteStatus'>
  & { creator: (
    { __typename?: 'User' }
...
export type UserFormResponseFragment = (
  { __typename?: 'UserResponse' }
  & { errors?: Maybe<Array<(
    { __typename?: 'FieldError' }
...
export const RegularUserFragmentDoc = gql`
  ...
  username
    ...
    `;
export const UserFormResponseFragmentDoc = gql`
    fragment UserFormResponse on UserResponse {
  errors {
    ...RegularError
  }
  user {
